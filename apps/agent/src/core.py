...
latency, pre-rendered greeting audio (src/speech_cache.py), and
...
from .config import CACHE_FILE, GREETING, TTS_MODEL
from .memory import CachedLLM
...
async def entrypoint(ctx: JobContext) -> None:
    ...
    agent = DrMalpaniNurse(instructions=system_prompt)
